...
import dev.decagon.ecommerce.dto.StripeResponse;
...
import dev.decagon.ecommerce.service.OrderService;
...
public class OrderController {
    ...
    public ResponseEntity<Object> getOrderById(@PathVariable("id") Integer id, @RequestParam("token") String token)
        ...
        // 3. call getOrder method of order service and pass orderId and user
